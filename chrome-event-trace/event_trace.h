...
#define TRACE_STR_COPY(str) \
    event_trace::TraceStringWithCopy(str)
...
#define TRACE_EVENT_BEGIN() event_trace::TraceLog::GetInstance()->BeginLogging();
#define TRACE_EVENT_FINISH() TRACE_EVENT_FLUSH_LOG(); event_trace::TraceLog::GetInstance()->EndLogging();
...
//CLM NOTE - I've removed the thread safety here.. which is most likely a bad thing.. but OK for my testing...
...
#define INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO(category) \
    ...
    if (!INTERNAL_TRACE_EVENT_UID(catstatic)) { \
      ...
      NoBarrier_Store(INTERNAL_TRACE_EVENT_UID(atomic), \
    ...
    do { \
      ...
      if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
        event_trace::AddTraceEvent( \
            ...
            event_trace::kNoEventId, flags, ##__VA_ARGS__); \
      } \
    } while (0)
...
#define INTERNAL_TRACE_EVENT_ADD_SCOPED(category, name, ...) \
    INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO(category); \
    event_trace::TraceEndOnScopeClose \
        INTERNAL_TRACE_EVENT_UID(profileScope); \
    if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
      event_trace::AddTraceEvent( \
          TRACE_EVENT_PHASE_BEGIN, \
          INTERNAL_TRACE_EVENT_UID(catstatic), \
          name, event_trace::kNoEventId, \
...
#define INTERNAL_TRACE_EVENT_ADD_SCOPED_IF_LONGER_THAN(threshold, \
        category, name, ...) \
    INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO(category); \
    event_trace::TraceEndOnScopeCloseThreshold \
        INTERNAL_TRACE_EVENT_UID(profileScope); \
    if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
...
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID(phase, category, name, id, flags, \
    ...
    do { \
      ...
      if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
        ...
        event_trace::TraceID trace_event_trace_id( \
